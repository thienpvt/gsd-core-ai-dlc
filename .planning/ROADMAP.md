...
- [x] **Phase 12: Onboarding & Rule-Authoring Docs** - End-user onboarding/install/consent/first-run docs, core governance workflow usage examples, and governance-rule authoring guide (completed 2026-07-08)
