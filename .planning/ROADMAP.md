...
- [x] 09-02-PLAN.md — Test-evidence capture (AUDIT-04) — TAP summary parser for node --test output + durable store under .planning/governance/tests/{NN}.json + test-evidence.schema.json
